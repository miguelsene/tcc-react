...
const Support = () => {
  ...
  return (
    <div className="support">
      <div className="support-header scroll-animate">
        <h1>
      ...
      <div className="support-tabs scroll-animate-left">
        <button 
      ...
      <div className="support-content">
        {activeTab === 'faq' && (
          <div className="faq-section scroll-animate-right">
        ...
        {activeTab === 'contact' && (
          <div className="contact-section scroll-animate-scale">
        ...
        {activeTab === 'guides' && (
          <div className="guides-section scroll-animate">
            <h2>Guias e Tutoriais</h2>
            <div className="guides-grid">
              <div className="guide-card">
                <i className="bi bi-plus-circle-fill guide-icon"></i>
                <h3>Como Criar um Bazar</h3>
                <p>Aprenda passo a passo como criar e configurar seu bazar</p>
                <button className="btn btn-secondary">Ver Guia</button>
              </div>
              <div className="guide-card">
                <i className="bi bi-camera-fill guide-icon"></i>
                <h3>Fotografias de Produtos</h3>
                <p>Dicas para tirar fotos atrativas dos seus produtos</p>
                <button className="btn btn-secondary">Ver Guia</button>
              </div>
              <div className="guide-card">
                <i className="bi bi-graph-up-arrow guide-icon"></i>
                <h3>Aumentar Vendas</h3>
                <p>Estratégias para impulsionar seu bazar</p>
                <button className="btn btn-secondary">Ver Guia</button>
              </div>
              <div className="guide-card">
                <i className="bi bi-shield-check guide-icon"></i>
                <h3>Segurança</h3>
